...
rsync -avz -e ssh --delete --exclude=/. --include=/.env --exclude=/resources/bot.yml --exclude=/tests --exclude=/storage/logs/ --exclude=/storage/app/ ./ "${SSH_USERNAME}@${SSH_HOST}:${SSH_DIRECTORY}"
